...
/*   Updated: 2025/01/23 20:26:22 by ellucas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures(t_data *data)
{
	...
	if (data->wall_img == NULL)
		exit(1);
	data->collect_img = mlx_xpm_file_to_image(data->mlx, "resources/collect.xpm", 
		&data->assets_width, &data->assets_height);
	...
	data->exit_close_img = mlx_xpm_file_to_image(data->mlx, 
		"resources/exit_close.xpm", &data->assets_width, &data->assets_height);
